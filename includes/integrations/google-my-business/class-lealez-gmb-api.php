...
$read_masks = array(
    // Mask 1
    'name,title,storeCode,storefrontAddress,phoneNumbers,websiteUri,regularHours,specialHours,moreHours,categories,latlng,serviceArea,openInfo,locationState,metadata,languageCode,profile',
    // Mask 2
    'name,title,storeCode,storefrontAddress,phoneNumbers,websiteUri,regularHours,specialHours,moreHours,categories,latlng,serviceArea,metadata,languageCode,profile',
    // Mask 3
    'name,title,storeCode,storefrontAddress,phoneNumbers,websiteUri,categories,latlng,serviceArea,metadata,languageCode,profile',
    // Mask 4
    'name,title,storefrontAddress,phoneNumbers,websiteUri,categories,latlng,serviceArea,metadata,profile',
    // Mask 5
    'name,title,storefrontAddress,phoneNumbers,websiteUri,categories,serviceArea,metadata,profile',
    // Mask 6
