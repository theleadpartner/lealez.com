...
trait Lealez_Unified_Location_Routing_Trait {
    ...
    private function enqueue_common_assets() {
            ...
            wp_localize_script(
                ...
                array(
                    'googleLabel' => __( 'Sincroniza con Google', 'lealez' ),
                    'localLabel'  => __( 'Solo Lealez', 'lealez' ),
                    'mixedLabel'  => __( 'Mixto', 'lealez' ),
                )
            );
        }
    ...
    public function replace_portal_output( $output, $tag, $attr, $match ) {
            ...
            if ( 'lealez_location_google_center' === $tag ) {
                ...
                return '<div class="lealez-portal"><div class="lealez-empty"><h3>' . esc_html__( 'El perfil de ubicación ahora está unificado', 'lealez' ) . '</h3><p>' . esc_html__( 'Selecciona una ubicación desde el listado para administrar datos internos y Google Business Profile en una sola pantalla.', 'lealez' ) . '</p><a class="lealez-btn lealez-btn-primary" href="' . esc_url( $this->page_url( 'locations' ) ) . '">' . esc_html__( 'Ver ubicaciones', 'lealez' ) . '</a></div></div>';
            }
    ...
    private function render_creation_scope_notice() {
            ...
            <div class="lealez-portal lealez-unified-create-notice">
                <div class="lealez-sync-legend">
                    <div><span class="lealez-sync-chip is-google-write"><?php esc_html_e( 'Sincroniza con Google', 'lealez' ); ?></span><p><?php esc_html_e( 'Se guarda primero en Lealez. Después de crear la ubicación podrás enviarlo a Google y verificar su revisión desde esta misma página.', 'lealez' ); ?></p></div>
                    <div><span class="lealez-sync-chip is-internal"><?php esc_html_e( 'Solo Lealez', 'lealez' ); ?></span><p><?php esc_html_e( 'Datos administrativos, de lealtad o responsables que no se publican en Google Business Profile.', 'lealez' ); ?></p></div>
                </div>
                <div class="lealez-gmb-guidance is-info"><strong><?php esc_html_e( 'Creación inicial', 'lealez' ); ?></strong><p><?php esc_html_e( 'Primero se crea la ficha local para obtener un ID seguro. Al guardar, continuarás en el perfil unificado con todos los módulos internos y de Google Business Profile.', 'lealez' ); ?></p></div>
            </div>
            <?php
